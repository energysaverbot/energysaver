...
double removejobs(int timeslot){
  ...
  //  cout<<"remove called"<<endl;
    ...
    cout<<"new util "<<newutil<<" power at new "<<p_onnewutil<<"old util "<<oldutil<<"p on old"<<p_onoldutil<<endl;
    ...
    cout<<" job removed is*  "<<jobid<<" util is  "<<ui<<"power reduced" <<power_reduced<<endl;
...
void addjobs(int timeslot,double power_added){
    ...
    cout<<"old pow "<<current_pow<<" old util "<<initial_util[timeslot]<<" newutil "<<new_total_util<<"pow added "<<power_added<<endl;
...
void displaytable(){
    ...
    printTableRow("\nRevenue after Algo 2: Schedule Tasks on ES without battery->", to_string(profit_phase1));
    printTableRow("\nRevenue after Algo 4: Offline Schedule for Infinite Battery: TS-GES-SIB->", to_string(profit_phase2));
...
int main()
{
   ...
   //cout<<" 1000 "<<calculateU(1000)<<endl;
    //cout<<" 1400 "<<calculateU(1400)<<endl;
     //cout<<" 700 "<<calculateU(700)<<endl;
   //cout<<" 500 "<<calculateU(500)<<endl;
   //cout<<" 950 "<<calculateU(950)<<endl;
   //cout<<" 550 "<<calculateU(550)<<endl;
   //cout<<"750 "<<calculateU(750)<<endl;
    return 0;
}
